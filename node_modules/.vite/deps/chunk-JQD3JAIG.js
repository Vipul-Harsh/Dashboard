...
} from "./chunk-GFJ2SWD3.js";
import {
  ButtonBase_default
} from "./chunk-GCBUWNHG.js";
import {
  Transition_default
} from "./chunk-KHHTCR4J.js";
import {
  require_react_dom
...
import {
  ...
  init_useForkRef,
  useForkRef_default
} from "./chunk-H3JEZVPP.js";
import {
  GlobalStyles_default
} from "./chunk-UXZBZVTF.js";
import {
  getOverlayAlpha_default,
  useTheme
} from "./chunk-RHSM2HAY.js";
import {
  init_styled,
  rootShouldForwardProp_default,
  slotShouldForwardProp_default,
  styled_default
} from "./chunk-VTBDSRXM.js";
import {
  useRtl
} from "./chunk-DGNJWZ7N.js";
import {
  HTMLElementType,
  chainPropTypes,
  clamp_default,
...
} from "./chunk-BP4JATKI.js";
import {
  _objectWithoutPropertiesLoose,
  init_objectWithoutPropertiesLoose
} from "./chunk-WHNK4O34.js";
import {
  require_prop_types
} from "./chunk-OLGVEPNQ.js";
import {
  require_jsx_runtime
} from "./chunk-G6FXIWLR.js";
import {
  require_react
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    var React114 = _interopRequireWildcard(require_react());
    ...
    function useTheme3(defaultTheme = null) {
      const contextTheme = React114.useContext(_styledEngine.ThemeContext);
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React11.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React11.useEffect(() => {
  ...
  const updateRootElementName = React11.useCallback((instance) => {
...
var PopperTooltip = React13.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children,
  ...
  const popperRef = React13.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React13.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React13.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React13.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React13.useState(resolveAnchorEl(anchorEl));
  React13.useEffect(() => {
...
var Popper = React13.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
var Popper3 = React14.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
var _excluded10 = ["className", "disableSpacing"];
...
var DialogActions = React16.forwardRef(function DialogActions2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogActions"
  });
  ...
  return (0, import_jsx_runtime14.jsx)(DialogActionsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ListContext = React17.createContext({});
if (true) {
...
var ListItemButton = React19.forwardRef(function ListItemButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemButton"
  });
  ...
  const listItemRef = React19.useRef(null);
...
var ListItemSecondaryAction = React20.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemSecondaryAction"
  });
...
var ListItem = React21.forwardRef(function ListItem2(inProps, ref) {
  ...
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded14), other = _objectWithoutPropertiesLoose(props, _excluded23);
  ...
  const children = React21.Children.toArray(childrenProp);
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types15.default.node, (props) => {
    const children = React21.Children.toArray(props.children);
...
var ChipRoot = styled_default("div", {
  ...
  return _extends({
    ...
    [`& .${chipClasses_default.deleteIcon}`]: _extends({
      ...
      color: theme.vars ? `rgba(${theme.vars.palette.text.primaryChannel} / 0.26)` : (0, import_colorManipulator5.alpha)(theme.palette.text.primary, 0.26),
      fontSize: 22,
      cursor: "pointer",
      margin: "0 5px 0 -6px",
      "&:hover": {
        color: theme.vars ? `rgba(${theme.vars.palette.text.primaryChannel} / 0.4)` : (0, import_colorManipulator5.alpha)(theme.palette.text.primary, 0.4)
      }
    }, ownerState.size === "small" && {
      fontSize: 16,
      marginRight: 4,
      ...
      color: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].contrastTextChannel} / 0.7)` : (0, import_colorManipulator5.alpha)(theme.palette[ownerState.color].contrastText, 0.7),
      "&:hover, &:active": {
  ...
  border: `1px solid ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.7)` : (0, import_colorManipulator5.alpha)(theme.palette[ownerState.color].main, 0.7)}`,
  [`&.${chipClasses_default.clickable}:hover`]: {
  ...
  [`&.${chipClasses_default.focusVisible}`]: {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.focusOpacity})` : (0, import_colorManipulator5.alpha)(theme.palette[ownerState.color].main, theme.palette.action.focusOpacity)
  },
  [`& .${chipClasses_default.deleteIcon}`]: {
    color: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.7)` : (0, import_colorManipulator5.alpha)(theme.palette[ownerState.color].main, 0.7),
    "&:hover, &:active": {
      color: (theme.vars || theme).palette[ownerState.color].main
    }
  }
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(React24.Fragment, {
    children: React24.cloneElement(children, childrenProps)
  });
}
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(React25.Fragment, {
...
var _excluded16 = ["onChange", "maxRows", "minRows", "style", "value"];
...
var TextareaAutosize = React26.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const calculateTextareaStyles = React26.useCallback(() => {
  ...
  return (0, import_jsx_runtime27.jsxs)(React26.Fragment, {
...
var Badge = React28.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime28.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
var _excluded18 = ["action", "children", "disabled", "focusableWhenDisabled", "onFocusVisible", "slotProps", "slots", "rootElementName"];
...
var Button = React30.forwardRef(function Button2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
...
true ? Button.propTypes = {
   ...
   * @default 'button'
   */
  rootElementName: import_prop_types21.default.string,
  /**
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React32.useRef(controlledProps);
  if (true) {
    React32.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function Dropdown(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(DropdownContext.Provider, {
    value: contextValue,
    children
  });
}
...
var FormControlContext2 = React35.createContext(void 0);
if (true) {
...
var FormControl = React36.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
  ...
  return (0, import_jsx_runtime32.jsx)(FormControlContext2.Provider, {
    value: childContext,
...
function useFormControlContext() {
  return React37.useContext(FormControlContext2);
}
...
var Input = React39.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsxs)(Root, _extends({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime33.jsx)(InputComponent, _extends({}, inputProps)), endAdornment]
  }));
});
true ? Input.propTypes = {
   ...
   */
  maxRows: import_prop_types24.default.number,
  /**
   * Minimum number of rows to display when multiline option is set to true.
   */
  minRows: import_prop_types24.default.number,
  /**
   ...
   */
  rows: import_prop_types24.default.number,
  /**
  ...
  slots: import_prop_types24.default.shape({
    ...
    textarea: import_prop_types24.default.elementType
  }),
  /**
   ...
   * @default 'text'
   */
  type: import_prop_types24.default.oneOf(["button", "checkbox", "color", "date", "datetime-local", "email", "file", "hidden", "image", "month", "number", "password", "radio", "range", "reset", "search", "submit", "tel", "text", "time", "url", "week"]),
  /**
...
function useTextNavigation(callback) {
  ...
  return React40.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React41.useCallback((event, value, reason) => {
  ...
  const stateComparers = React41.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React41.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React41.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React41.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React41.useRef([]);
  React41.useEffect(() => {
  ...
  const getItemState = React41.useCallback((item) => {
...
var ListContext2 = React42.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const listContext = React43.useContext(ListContext2);
  if (!listContext) {
  ...
  const createHandleClick = React43.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React43.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React44.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React44.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React44.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React44.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React44.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React44.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React44.useCallback(function getItemIndex2(id) {
...
function useCompoundItem(id, itemMetadata) {
  const context = React45.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React45.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React46.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React46.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React46.useMemo(() => Array.from(subitems.keys()), [subitems]);
  ...
  const reducerActionContext = React46.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
function MenuProvider(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(CompoundComponentContext.Provider, {
    ...
    children: (0, import_jsx_runtime35.jsx)(ListContext2.Provider, {
...
var TransitionContext = React49.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React50.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React51.useState(true);
  const hasPendingExitTransition = React51.useRef(false);
  const registeredTransitions = React51.useRef(0);
  const [hasTransition, setHasTransition] = React51.useState(false);
  const previousRequestEnter = React51.useRef(requestEnter);
  React51.useEffect(() => {
  ...
  const handleExited = React51.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React51.useCallback(() => {
...
var PopupContext = React52.createContext(null);
if (true) {
...
var _excluded21 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy"];
...
var Popup = React53.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React53.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
  ...
  return (0, import_jsx_runtime36.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime36.jsx)(PopupContext.Provider, {
      value: popupContextValue,
      children: (0, import_jsx_runtime36.jsx)(TransitionContext.Provider, {
        value: contextValue,
...
true ? Popup.propTypes = {
   ...
   */
  anchor: import_prop_types25.default.oneOfType([HTMLElementType, import_prop_types25.default.object, import_prop_types25.default.func]),
  /**
   * @ignore
   */
   ...
   */
  middleware: import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf([false]), import_prop_types25.default.shape({
    fn: import_prop_types25.default.func.isRequired,
    name: import_prop_types25.default.string.isRequired,
    options: import_prop_types25.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.number, import_prop_types25.default.shape({
    alignmentAxis: import_prop_types25.default.number,
    crossAxis: import_prop_types25.default.number,
    mainAxis: import_prop_types25.default.number
  })]),
  /**
...
var _excluded24 = ["actions", "anchor", "children", "onItemsChange", "slotProps", "slots"];
...
var Menu = React54.forwardRef(function Menu2(props, forwardedRef) {
  ...
  if (open === true && anchor == null) {
    return (0, import_jsx_runtime37.jsx)(Root, _extends({}, rootProps, {
      children: (0, import_jsx_runtime37.jsx)(Listbox, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime37.jsx)(MenuProvider, {
          value: contextValue,
          children
        })
      }))
  ...
  return (0, import_jsx_runtime37.jsx)(Popup, _extends({
    keepMounted: true
  }, rootProps, {
    open,
    anchor,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React55.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React56.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItemContextStabilizer(id) {
  const listContext = React58.useContext(ListContext2);
  if (!listContext) {
...
var _excluded26 = ["children", "disabled", "label", "id", "slotProps", "slots"];
...
var InnerMenuItem = React59.memo(React59.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React59.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
  ...
  return (0, import_jsx_runtime39.jsx)(ListContext2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime39.jsx)(InnerMenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
true ? MenuItem2.propTypes = {
   ...
   * @default false
   */
  disableFocusOnHover: import_prop_types28.default.bool,
  /**
...
function useModal(parameters) {
  ...
  const isTopModal = React60.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var _excluded27 = ["children", "closeAfterTransition", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
var Modal = React61.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
  ...
  return (0, import_jsx_runtime40.jsx)(Portal, {
    ref: portalRef,
    container,
    disablePortal,
    children: (0, import_jsx_runtime41.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime40.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime40.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React61.cloneElement(children, childProps)
      })]
    }))
  });
});
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React62.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React62.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React62.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var _excluded28 = ["className", "defaultValue", "disabled", "endAdornment", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "startAdornment", "step", "value", "slotProps", "slots"];
...
var NumberInput = React63.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime43.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime42.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime42.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime42.jsx)(Input5, _extends({}, inputProps)), endAdornment]
  }));
});
...
function useUtilityClasses22(disabled) {
  const slots = {
...
var OptionGroup = React64.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
  ...
  const classes = useUtilityClasses22(disabled);
  const rootProps = useSlotProps({
    elementType: Root,
    externalSlotProps: slotProps.root,
    externalForwardedProps: other,
  ...
  return (0, import_jsx_runtime45.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime44.jsx)(Label, _extends({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime44.jsx)(List3, _extends({}, listProps, {
...
function useOption(params) {
  ...
  const selectOption = React65.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React66.useContext(ListContext2);
  if (!listContext) {
...
function useUtilityClasses23(ownerState) {
  const {
    disabled,
    highlighted,
    selected
...
var InnerOption = React67.memo(React67.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React67.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
  ...
  return (0, import_jsx_runtime46.jsx)(ListContext2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime46.jsx)(InnerOption, _extends({}, props, {
      ref
    }))
  });
});
...
function useSelect(props) {
  ...
  const getItemDomElement = React68.useCallback((itemId) => {
    var _subitems$get$ref$cur, _subitems$get;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React68.useRef(open);
  useEnhancedEffect_default(() => {
...
var _span2;
var _excluded31 = ["areOptionsEqual", "autoComplete", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "placeholder", "slotProps", "slots", "value"];
function defaultRenderValue(selectedOptions) {
  var _selectedOptions$labe;
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime48.jsx)(React70.Fragment, {
...
var Select = React70.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime49.jsxs)(React70.Fragment, {
    children: [(0, import_jsx_runtime48.jsx)(Button3, _extends({}, buttonProps, {
      children: (_ref = (_renderValue = renderValue(selectedOptionsMetadata)) != null ? _renderValue : placeholder) != null ? _ref : (
        ...
        _span2 || (_span2 = (0, import_jsx_runtime48.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      )
    })), buttonDefined && (0, import_jsx_runtime48.jsx)(Popup, _extends({
      slots: {
        root: PopupComponent
      }
    }, popupProps, {
      children: (0, import_jsx_runtime48.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime48.jsx)(SelectProvider, {
          value: contextValue,
          children
        })
      }))
    })), (0, import_jsx_runtime48.jsx)("input", _extends({}, getHiddenInputProps(), {
      autoComplete
    }))]
  });
});
true ? Select.propTypes = {
   ...
   */
  placeholder: import_prop_types33.default.node,
  /**
  ...
  slotProps: import_prop_types33.default.shape({
    ...
    popup: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
  ...
  slots: import_prop_types33.default.shape({
    ...
    popup: import_prop_types33.default.elementType,
...
var _excluded32 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React72.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime51.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime50.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime50.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime51.jsxs)(React72.Fragment, {
        children: [(0, import_jsx_runtime50.jsx)(Mark, _extends({
          "data-index": index2
        ...
        })), mark.label != null ? (0, import_jsx_runtime50.jsx)(MarkLabel, _extends({
          "aria-hidden": true,
          "data-index": index2
      ...
      return (0, import_jsx_runtime51.jsxs)(Thumb, _extends({
        "data-index": index2
        ...
        children: [(0, import_jsx_runtime50.jsx)(Input5, _extends({
          "data-index": index2,
          ...
          value: values[index2]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime50.jsx)(ValueLabel, _extends({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React74.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime52.jsx)(ClickAwayListener, _extends({}, clickAwayListenerProps, {
    children: (0, import_jsx_runtime52.jsx)(Root, _extends({}, rootProps, {
      children
    }))
  }));
});
...
var Switch = React76.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime54.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime53.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime53.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime53.jsx)(Input5, _extends({}, inputProps))]
  }));
});
...
function LastPageIconDefault() {
  return _span3 || (_span3 = (0, import_jsx_runtime55.jsx)("span", {
    children: "⇾|"
  }));
}
function FirstPageIconDefault() {
  return _span22 || (_span22 = (0, import_jsx_runtime55.jsx)("span", {
    children: "|⇽"
  }));
}
function NextPageIconDefault() {
  return _span32 || (_span32 = (0, import_jsx_runtime55.jsx)("span", {
    children: "⇾"
  }));
}
function BackPageIconDefault() {
  return _span4 || (_span4 = (0, import_jsx_runtime55.jsx)("span", {
    children: "⇽"
  }));
}
...
var TablePaginationActions = React77.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime56.jsxs)(Root, _extends({}, rootProps, {
    children: [showFirstButton && (0, import_jsx_runtime55.jsx)(FirstButton, _extends({}, firstButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime55.jsx)(LastPageIcon, {}) : (0, import_jsx_runtime55.jsx)(FirstPageIcon, {})
    })), (0, import_jsx_runtime55.jsx)(BackButton, _extends({}, backButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime55.jsx)(NextPageIcon, {}) : (0, import_jsx_runtime55.jsx)(BackPageIcon, {})
    })), (0, import_jsx_runtime55.jsx)(NextButton, _extends({}, nextButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime55.jsx)(BackPageIcon, {}) : (0, import_jsx_runtime55.jsx)(NextPageIcon, {})
    })), showLastButton && (0, import_jsx_runtime55.jsx)(LastButton, _extends({}, lastButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime55.jsx)(FirstPageIcon, {}) : (0, import_jsx_runtime55.jsx)(LastPageIcon, {})
    }))]
  }));
});
...
var TablePagination = React78.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime57.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime58.jsxs)(Toolbar, _extends({}, toolbarProps, {
      children: [(0, import_jsx_runtime57.jsx)(Spacer, _extends({}, spacerProps)), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime57.jsx)(SelectLabel, _extends({}, selectLabelProps, {
        children: labelRowsPerPage
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime57.jsx)(Select5, _extends({}, selectProps, {
      ...
      })), (0, import_jsx_runtime57.jsx)(DisplayedRows, _extends({}, displayedRowsProps, {
      ...
      })), (0, import_jsx_runtime57.jsx)(Actions, _extends({}, actionsProps))]
    }))
  }));
});
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime59.jsx)(TabsContext.Provider, {
...
var Tabs = React82.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime60.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime60.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
var TabPanel = React84.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime61.jsx)(TabPanelRoot, _extends({}, tabPanelRootProps, {
...
function TabsListProvider(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime62.jsx)(ListContext2.Provider, {
      value: listContextValue,
      children
    })
  });
...
var TabsList = React87.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime63.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime63.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
      children
    }))
  });
});
...
var _excluded40 = ["action", "children", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots", "value"];
...
var Tab = React89.forwardRef(function Tab2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime64.jsx)(TabRoot, _extends({}, tabRootProps, {
    children
  }));
});
true ? Tab.propTypes = {
...
function CssAnimation(props) {
  ...
  const hasExited = React90.useRef(true);
  React90.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React90.useCallback((event) => {
...
true ? CssAnimation.propTypes = {
  ...
  enterAnimationName: import_prop_types42.default.string,
  enterClassName: import_prop_types42.default.string,
  exitAnimationName: import_prop_types42.default.string,
  exitClassName: import_prop_types42.default.string
} : void 0;
...
var CssTransition = React91.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React91.useState(false);
  React91.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React91.useCallback((event) => {
...
true ? CssTransition.propTypes = {
  ...
  lastTransitionedPropertyOnEnter: import_prop_types43.default.string,
  lastTransitionedPropertyOnExit: import_prop_types43.default.string
} : void 0;
...
var inputGlobalStyles = (0, import_jsx_runtime67.jsx)(GlobalStyles_default, {
  styles: {
...
var InputBase = React92.forwardRef(function InputBase2(inProps, ref) {
  ...
  const {
    current: isControlled
  } = React92.useRef(value != null);
  const inputRef = React92.useRef();
  const handleInputRefWarning = React92.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const [focused, setFocused] = React92.useState(false);
  const muiFormControl = useFormControl();
  if (true) {
    React92.useEffect(() => {
      if (muiFormControl) {
  ...
  const checkDirty = React92.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  return (0, import_jsx_runtime68.jsxs)(React92.Fragment, {
...
true ? InputBase.propTypes = {
   ...
   * @default false
   */
  disableInjectingGlobalStyles: import_prop_types44.default.bool,
  /**
   ...
   */
  onInvalid: import_prop_types44.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  renderSuffix: import_prop_types44.default.func,
  /**
   * If `true`, the `input` element is required.
   * The prop defaults to the value (`false`) inherited from the parent FormControl component.
   */
...
var Input3 = React93.forwardRef(function Input4(inProps, ref) {
...
var FilledInput = React94.forwardRef(function FilledInput2(inProps, ref) {
  var _ref, _slots$root, _ref2, _slots$input;
  const props = useThemeProps({
    props: inProps,
    name: "MuiFilledInput"
...
var OutlinedInput = React96.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime73.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime73.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime72.jsxs)(React96.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormLabel = React97.forwardRef(function FormLabel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormLabel"
  });
  ...
  return (0, import_jsx_runtime74.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [children, fcs.required && (0, import_jsx_runtime74.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
var InputLabel = React98.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime75.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_default(classes.root, className)
...
var _excluded50 = ["children", "className", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "variant"];
...
var FormControl3 = React99.forwardRef(function FormControl4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React99.useState(() => {
    let initialAdornedStart = false;
    if (children) {
      React99.Children.forEach(children, (child) => {
  ...
  const [filled, setFilled] = React99.useState(() => {
  ...
  const [focusedState, setFocused] = React99.useState(false);
  ...
  let registerEffect;
  if (true) {
    const registeredInput = React99.useRef(false);
    registerEffect = () => {
...
var _span6;
var _excluded51 = ["children", "className", "component", "disabled", "error", "filled", "focused", "margin", "required", "variant"];
...
var FormHelperText = React100.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
  ...
  return (0, import_jsx_runtime77.jsx)(FormHelperTextRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var _excluded52 = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
...
var MenuList = React101.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  const textCriteriaRef = React101.useRef({
    keys: [],
    repeating: true,
  ...
  React101.useImperativeHandle(actions, () => ({
  ...
  React101.Children.forEach(children, (child, index2) => {
  ...
  const items = React101.Children.map(children, (child, index2) => {
    if (index2 === activeItemIndex) {
      ...
      return React101.cloneElement(child, newChildProps);
    }
    return child;
  });
  return (0, import_jsx_runtime78.jsx)(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown2,
...
true ? MenuList.propTypes = {
   ...
   * @default false
   */
  autoFocusItem: import_prop_types53.default.bool,
  /**
...
var Backdrop = React102.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime79.jsx)(TransitionComponent, _extends({
    in: open,
    timeout: transitionDuration
  }, other, {
    children: (0, import_jsx_runtime79.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var Modal3 = React103.forwardRef(function Modal4(inProps, ref) {
  ...
  return (0, import_jsx_runtime80.jsx)(Portal, {
    ref: portalRef,
    container,
    disablePortal,
    children: (0, import_jsx_runtime81.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime80.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime80.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React103.cloneElement(children, childProps)
      })]
    }))
  });
});
true ? Modal3.propTypes = {
   ...
   * @default false
   */
  closeAfterTransition: import_prop_types55.default.bool,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableEnforceFocus: import_prop_types55.default.bool,
  /**
   * If `true`, hitting escape will not fire the `onClose` callback.
   * @default false
   */
   ...
   * @default false
   */
  disableRestoreFocus: import_prop_types55.default.bool,
  /**
   * Disable the scroll lock behavior.
   * @default false
   */
  disableScrollLock: import_prop_types55.default.bool,
  /**
   * If `true`, the backdrop is not rendered.
   * @default false
   */
   ...
   * @deprecated Use the `onClose` prop with the `reason` argument to handle the `backdropClick` events.
   */
  onBackdropClick: import_prop_types55.default.func,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   *
   ...
   * A function called when a transition enters.
   */
  onTransitionEnter: import_prop_types55.default.func,
  /**
   * A function called when a transition has exited.
   */
  onTransitionExited: import_prop_types55.default.func,
  /**
   * If `true`, the component is shown.
   */
...
var Popover = React104.forwardRef(function Popover2(inProps, ref) {
  ...
  const getAnchorOffset = React104.useCallback(() => {
  ...
  const getTransformOrigin = React104.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React104.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React104.useState(open);
  const setPositioningStyles = React104.useCallback(() => {
  ...
  React104.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
  ...
  return (0, import_jsx_runtime82.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: (0, import_jsx_runtime82.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime82.jsx)(PaperSlot, _extends({}, paperProps, {
        children
      }))
    }))
  }));
...
var Menu3 = React105.forwardRef(function Menu4(inProps, ref) {
  ...
  const menuListActionsRef = React105.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React105.Children.map(children, (child, index2) => {
  ...
  return (0, import_jsx_runtime83.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime83.jsx)(MenuMenuList, _extends({
...
var NativeSelectInput = React106.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime85.jsxs)(React106.Fragment, {
    children: [(0, import_jsx_runtime84.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime84.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React107.forwardRef(function SelectInput2(props, ref) {
  ...
  const displayRef = React107.useRef(null);
  const [displayNode, setDisplayNode] = React107.useState(null);
  const {
    current: isOpenControlled
  } = React107.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React107.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React107.useCallback((node) => {
  ...
  React107.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  return (0, import_jsx_runtime87.jsxs)(React107.Fragment, {
    children: [(0, import_jsx_runtime86.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span7 || (_span7 = (0, import_jsx_runtime86.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
    })), (0, import_jsx_runtime86.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime86.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime86.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
true ? SelectInput.propTypes = {
   ...
   * @ignore
   */
  "aria-label": import_prop_types59.default.string,
  /**
   * @ignore
   */
   ...
   * The icon that displays the arrow.
   */
  IconComponent: import_prop_types59.default.elementType.isRequired,
  /**
   ...
   * @ignore
   */
  type: import_prop_types59.default.any,
  /**
   * The input value.
   */
   ...
   * The variant to use.
   */
  variant: import_prop_types59.default.oneOf(["standard", "outlined", "filled"])
} : void 0;
...
var ArrowDropDown_default = createSvgIcon((0, import_jsx_runtime88.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var Select3 = React109.forwardRef(function Select4(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime89.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime89.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime89.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, InputComponent.ref);
  return (0, import_jsx_runtime89.jsx)(React109.Fragment, {
    children: React109.cloneElement(InputComponent, _extends({
...
true ? Select3.propTypes = {
   ...
   * @default false
   */
  autoWidth: import_prop_types60.default.bool,
  /**
   * The option elements to populate the select with.
   ...
   * @default false
   */
  displayEmpty: import_prop_types60.default.bool,
  /**
   * The icon that displays the arrow.
   ...
   * be labelled by the additional label and the selected value.
   */
  labelId: import_prop_types60.default.string,
  /**
   * Props applied to the [`Menu`](/material-ui/api/menu/) element.
   */
  MenuProps: import_prop_types60.default.object,
  /**
   * If `true`, `value` must be an array and the menu will support multiple selections.
   * @default false
   */
   ...
   * @default false
   */
  native: import_prop_types60.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   * Props applied to the clickable div element.
   */
  SelectDisplayProps: import_prop_types60.default.object,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   */
  value: import_prop_types60.default.oneOfType([import_prop_types60.default.oneOf([""]), import_prop_types60.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
var TextField = React110.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime90.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime91.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime90.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime90.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime90.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
true ? TextField.propTypes = {
   ...
   */
  FormHelperTextProps: import_prop_types61.default.object,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   */
  helperText: import_prop_types61.default.node,
  /**
   * The id of the `input` element.
   ...
   */
  InputLabelProps: import_prop_types61.default.object,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Attributes) applied to the `input` element.
   */
   ...
   * @default false
   */
  select: import_prop_types61.default.bool,
  /**
...
var DialogContent = React111.forwardRef(function DialogContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogContent"
  });
  ...
  return (0, import_jsx_runtime92.jsx)(DialogContentRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
true ? DialogContent.propTypes = {
   ...
   * @default false
   */
  dividers: import_prop_types62.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var DialogContext = React112.createContext({});
if (true) {
...
var _excluded62 = ["aria-describedby", "aria-labelledby", "BackdropComponent", "BackdropProps", "children", "className", "disableEscapeKeyDown", "fullScreen", "fullWidth", "maxWidth", "onBackdropClick", "onClick", "onClose", "open", "PaperComponent", "PaperProps", "scroll", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
var Dialog = React113.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React113.useRef();
  const handleMouseDown = (event) => {
  ...
  const dialogContextValue = React113.useMemo(() => {
    return {
      titleId: ariaLabelledby
    };
  }, [ariaLabelledby]);
  return (0, import_jsx_runtime93.jsx)(DialogRoot, _extends({
    className: clsx_default(classes.root, className),
    ...
    children: (0, import_jsx_runtime93.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime93.jsx)(DialogContainer, {
        className: clsx_default(classes.container),
        onMouseDown: handleMouseDown,
        ownerState,
        children: (0, import_jsx_runtime93.jsx)(DialogPaper, _extends({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState,
          children: (0, import_jsx_runtime93.jsx)(DialogContext_default.Provider, {
...
true ? Dialog.propTypes = {
   ...
   * @default false
   */
  fullScreen: import_prop_types63.default.bool,
  /**
   ...
   * @default 'sm'
   */
  maxWidth: import_prop_types63.default.oneOfType([import_prop_types63.default.oneOf(["xs", "sm", "md", "lg", "xl", false]), import_prop_types63.default.string]),
  /**
   * Callback fired when the backdrop is clicked.
   * @deprecated Use the `onClose` prop with the `reason` argument to handle the `backdropClick` events.
   */
   ...
   * @default Paper
   */
  PaperComponent: import_prop_types63.default.elementType,
  /**
   * Props applied to the [`Paper`](/material-ui/api/paper/) element.
   * @default {}
   */
   ...
   * @default 'paper'
   */
  scroll: import_prop_types63.default.oneOf(["body", "paper"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JQD3JAIG.js.map
